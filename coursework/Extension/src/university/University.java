 ...
 */
public class University implements Serializable { // instance variables, all university objects should have a budget,
  // an instance of estate and a reputation
  private float budget;
  private Estate estate;
  private int reputation;
  private HumanResource humanResource;
  private ArrayList<Research> researchFacilities;
  ...
  public University(
    ...
    this.researchFacilities = new ArrayList<>();
  }

  /**
   * Handles the building of research facilities
   * and subtracts 1000 ECS coins from university's budget.
   *
   * @param name Takes the name of the facility as a parameter.
   */
  public void addReasearch(String name) {
    Research research = new Research(name);
    this.researchFacilities.add(research);
    this.budget -= 1000; //cost to the university of building a research facility
  }

  /**
   * Returns an ArrayList of Research Objects.
   *
   * @return Returns an array list of all research facilities.
   */
  public ArrayList<Research> getResearchFacilities() {
    return this.researchFacilities;
  }
